<template>
    <el-table :data="tableData" ref="table" v-loading="loadingText"
              :element-loadingText-text="loadingText" v-on="elListeners" v-bind="elAttrs">
        <slot name="left"></slot>
...
<script>
    ...
    export default{
        ...
        components: {
            Column, Actions, ElTable, ElTableColumn
        },
        created () {
        },
        methods: {
        ...
        computed: {
            ...
            tableItems(){
                return arrayNormalize(this.items, {}, this.normalizeItem)
            },
            visiableItems () {
